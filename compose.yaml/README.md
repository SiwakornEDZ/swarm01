...
* ส่วน deploy เป็นการกำหนดการ deploy container นี้ ในที่นี้จะ deploy แค่ 1 replica เท่านั้น และกำหนด label ของ Traefik เพื่อให้ Traefik ทำงานได้ถูกต้อง โดยมีหลายตัวอย่างดังนี้
